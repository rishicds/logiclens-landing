...
const Footer = () => {
  ...
  <div className="relative block h-32 lg:col-span-2 lg:h-full">
    <img
      src="https://images.pexels.com/photos/19746282/pexels-photo-19746282/free-photo-of-surveillance-warning-sign-with-emoji.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      alt=""
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="/products" className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                Products
              </a>
            </li>
    ...
    <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
          &copy; 2024. LogicLens. All rights reserved.
        </p>
      </div>
    </div>
  </div>
